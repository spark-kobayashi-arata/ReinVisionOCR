...
def draw_text(
    ...
    Args:
        ...
        anchor (Union[str, None], optional): _description_. Defaults to None.
    ...
    if shadow and outline:
        drawer.text(add_tuple(text_pos, shadow_offset), text, shadow_color, font, anchor, stroke_width=outline_width, stroke_fill=shadow_color)
    elif shadow:
        drawer.text(add_tuple(text_pos, shadow_offset), text, shadow_color, font, anchor)

    if outline:
        drawer.text(text_pos, text, text_color, font, anchor, stroke_width=outline_width, stroke_fill=outline_color)
    else:
        drawer.text(text_pos, text, text_color, font, anchor)
